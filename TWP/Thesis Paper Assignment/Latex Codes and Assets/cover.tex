...
\begin{titlepage}
    ...
    \huge \textnormal{ENG 401 : Technical Writing \& Presentation
}
    \vspace{1in} % Adjusts vertical space after the course title

    \Large \textnormal{Title: Effect of Foreign Films on the Moral Conduct of Undergraduate Students: An Exploratory Study at USTC, Bangladesh
}
    ...
    \begin{tabular}{|p{0.4\textwidth}|p{0.6\textwidth}|} % Set column widths to 40% and 60%
        ...
        \hline
        \textbf{Submission Date} & 05.10.2025 \\
        \hline
    \end{tabular}
    \vspace{1cm}
